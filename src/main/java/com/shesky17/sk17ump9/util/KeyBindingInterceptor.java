...
//
///**
// * The following code is originally from: https://gist.github.com/TheGreyGhost/7033821
// * I only fixed some of the outdated code
// */
//
///**
...
//  {
//    super(existingKeyBinding.getKeyDescription(),
//            existingKeyBinding.getKeyConflictContext(),
//            existingKeyBinding.getKeyCode(),
//            existingKeyBinding.getKeyCategory());
//    // the base constructor automatically adds the class to the keybindArray and hash, which we don't want, so undo it
//    getKeybinds().remove(this);
//
//    this.interceptionActive = false;
//    this.setKeyBindState(this.getKeyCode(), false); //pressed = false;
//    this.pressTime = 0;
